...
def match_2img(imgL_path,imgR_path,MinMatchNum):
    ...
    if len(BetterChoose1) > MinMatchNum:
        ...
        scal=0.7
        cv2.imwrite('/home/ucar/ucar_ws/src/taurus_pkg/darknet/connect.jpg',cv2.resize(LeftAndRight,(0, 0),fx=scal,fy=scal,interpolation=cv2.INTER_NEAREST)) 
    del L,R,LeftAndRight
