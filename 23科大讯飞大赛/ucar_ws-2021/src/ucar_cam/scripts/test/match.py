...
import numpy as np
def match_2img(imgL_path,imgR_path,MinMatchNum,photo_count):
    ...
    if len(BetterChoose1) > MinMatchNum:
        ...
        scal=1
        cv2.imwrite('/home/ucar/ucar_ws/src/taurus_pkg/darknet_connect/'+str(photo_count)+'.jpg',cv2.resize(LeftAndRight,(0, 0),fx=scal,fy=scal,interpolation=cv2.INTER_NEAREST)) 

if __name__ =="__main__":
    print("Match!")
    match_2img("/home/ucar/ucar_ws/src/taurus_pkg/darknet/0.jpg","/home/ucar/ucar_ws/src/taurus_pkg/darknet/1.jpg",3)
