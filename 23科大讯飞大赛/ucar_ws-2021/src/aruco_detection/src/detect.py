...
class image_convert_pub:
  ...
  def __init__(self):
    ...
    self.id_pub = rospy.Publisher("/easy_aruco_node/aruco_id", String, queue_size=1)
  ...
  def callback(self,data):
    ...
    if ids_list is not None:
      #print(ids_list[0])
      if ids_list[0]==0 or ids_list[0]==1 or ids_list[0]==2:
        self.id_pub.publish(str(ids_list[0][0]))
        rospy.signal_shutdown("detect aruco finish")
    #else:
